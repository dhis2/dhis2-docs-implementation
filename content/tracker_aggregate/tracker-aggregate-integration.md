...
<!-- TODO: Brief summary on how this is done -->
...
> * not truly integrated/comparable with aggregated data, for example the same disaggregations cannot be applied
...
<!-- {Screenshot of data element with code - covax + Screenshot of coc with code - covax} -->
...
<!-- TODO: update with proper example -->
```
...
### Known issues
- There is a bug in 2.33.3/2.33.4 that prevents custom attributes from being exposed in the UI ([Jira 8755](https://jira.dhis2.org/browse/DHIS2-8755)): for now attribute values must be added to program indicators via the API.
