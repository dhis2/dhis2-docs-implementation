...
| :----------------------------------------- | :------------------------------------------------------------------------------------------------------------------------------------ | :------------------------------------------------------------------------------------------------ | :------------------------- | :--------------------------- | :---------------------------------------------------------- | :------------------------------------------------------------------------- |
| Google Earth Engine (GEE)                  | [Catalog](https://developers.google.com/earth-engine/datasets) <br> <br> [Earth Engine](https://earthengine.google.com/)                                                                         | Various: historical/current weather variables, land cover, satellite imagery, climate projections | JavaScript, Python, REST   | Various                      | Access to almost any indicator from multiple sources/models | Must know one of the supported languages                                   |
| Climate Data Store (CDS)                   | [Home](https://cds.climate.copernicus.eu/cdsapp#!/home)<br> <br> [Datasets](https://cds.climate.copernicus.eu/cdsapp#!/search?type=dataset) | Various, especially ERA5 reanalysis products                                                      | Python                     | netCDF                       | Easier-to-use API compared to GEE                           | Large file sizes                                                           |
| Climate Hazards Center / CHIRPS            | [Data](https://data.chc.ucsb.edu/products/CHIRPS-2.0/)                                                                                | Precipitation                                                                                     | None                       | .tif, .png (compressed)      | No special software needed                                  | Must download each time point separately; site navigation can be confusing |
| Climate Research Unit (CRU)                | [Datasets](https://crudata.uea.ac.uk/cru/data/hrg/#current)                                                                           | Temperature and others                                                                            | None                       | .nc, .dat, .stn (compressed) | No special software needed                                  | Must download each time point separately; site navigation can be confusing |
| NASA GISS Station Temperature Data         | [Datasets](https://data.giss.nasa.gov/gistemp/station_data_v4_globe/)                                                                 | Surface temperature (monthly mean)                                                                | None                       | .txt, .csv                   | Actual station data                                         | Many missing values; poor coverage in some regions                         |
| World Bank Climate Change Knowledge Portal | [Portal](https://climateknowledgeportal.worldbank.org/download-data)                                                                  | Projected indicators under future SSP scenarios (CMIP models), some historical data (CRU, ERA5)   | None                       | Excel, others?               | Good source for projected and historical data               | Limited download customization                                             |
