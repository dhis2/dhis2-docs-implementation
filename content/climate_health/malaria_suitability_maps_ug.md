...
## Implementation in DHIS2 { #malaria_suitability_config }
...
<table>
    ...
    <tbody>
        <tr>
            <td style="background-color: red; color: black">3</td>
            <td>All three conditions met</td>
        </tr>
        <tr>
            <td style="background-color: yellow; color: black">2</td>
            <td>Two conditions met</td>
        </tr>
        <tr>
            <td style="background-color: lightgreen; color: black">1</td>
            <td>One condition met</td>
        </tr>
        <tr>
            <td style="background-color: green; color: black">0</td>
            <td>None of the conditions were met</td>
        </tr>
    </tbody>
</table>
...
<table>
    ...
    <tbody>
        <tr>
            <td style="background-color: red; color: black">1</td>
            <td>Suitable</td>
        </tr>
        <tr>
            <td style="background-color: green; color: black">0</td>
...
| Composite suitability parameter, by district | Suitable months for malaria in a year (darker=more months)   |
|:--|:--|
| ![Fig 1](resources/images/image2.png) | ![Fig 2](resources/images/image5.png)|

|**Climate suitability and malaria cases**|
|:--|
|![Fig 4.](resources/images/image1.png){ .center width=90% }|

| Climatic suitability (precipitation) | Climatic suitability (temperature)   |
|:--|:--|
| ![Fig. 4](resources/images/image4.png) | ![Fig. 5](resources/images/image3.png)|
