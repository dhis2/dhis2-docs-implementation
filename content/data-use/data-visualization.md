...
![Chart Chooser by Extreme Presentation Method](resources/image/dataviz_002.png)
...
![Data visualization styles available in DHIS2](resources/image/dataviz_025.png)
...
![Scatterplot found in the EPI-Program Performance Dashboard plotting coverage vs dropout rates](resources/image/dataviz_003.png)
...
![Double axis chart with columns and line showing measles cases and coverage](resources/image/dataviz_004.png)  
...
![Ordered stacked bar chart of TB cases by reporting district](resources/image/dataviz_005.png)
...
![Slopes on inpatient malaria incidence across different Districts through time](resources/image/dataviz_006.png)  
...
![Columns for monthly HIV cases](resources/image/dataviz_007.png)  
...
![Area chart for the volume of malaria cases in three districts](resources/image/dataviz_008.png)
Magnitude   
...
![Paired columns of HIV new cases and HIV new cases who started ART across different districts](resources/image/dataviz_009.png) 
...
![Radar chart on Rehab condition groups and their use across two districts](resources/image/dataviz_010.png)  
...
![Imrpove the visualization choosing the most suitable colour set](resources/image/dataviz_022.png)  
...
![Stacked columns for TB cases - lab confirmed and clinically confirmed](resources/image/dataviz_011.png)
...
![Sex for notified TB cases](resources/image/dataviz_012.png)  
...
![Coverage rate for BCG](resources/image/dataviz_026.png)  
...
![Coverage rate for BCG with a colour-based legend representative of the EPI coverage threshold](resources/image/dataviz_027.png)  
...
![Pivot table of the target population for a supplementary immunisation activity by age groups, distance from the PoC, and locations. Note the row and column totals as well as the subtotals by category](resources/image/dataviz_028.png)  
...
![Scorecard highlighting the MR coverage reported by routine EPI- and SIA-related activities](resources/image/dataviz_031.png)  
...
![Map showing the percentage of PTB-BC cases in a region](resources/image/dataviz_013.png)  
...
![Map showing number of notified cases in a region](resources/image/dataviz_014.png)  

![Map showing the location of the unvaccinated children and the reason for the missed vaccination](resources/image/dataviz_015.png)  

- **Dot density**: Shows the location of events. Each dot represents a set number of occurrences of a phenomenon.  

![Map showing the population density in the region](resources/image/dataviz_021.png)  
...
![Map showing the mean temperatures across the country](resources/image/dataviz_016.png)  
...
![The chart appears cluttered and difficult to interpret](resources/image/dataviz_017.png)  
...
![Cluttered graph by lower OUs](resources/image/dataviz_032.png)  
...
![Overloading a map with too many layers and data points](resources/image/dataviz_023.png)  
...
![The items in the dashboards are too small for what they need to convey, the labels are unreadable, the pivot table does not have space to display the variables](resources/image/dataviz_023.png)  
...
![Contextualized graph](resources/image/dataviz_024.png)  
...
![Pie charts with a lare number of categories to be compared](resources/image/dataviz_018.png)  
...
![Doses given as a total within the country and the doses by district](resources/image/dataviz_019.png)  
...
![Spider chart used wrongly to display the changes in notified TB cases over time](resources/image/dataviz_029.png)  
...
![Double axis wrongly unifying stand alone entities](resources/image/dataviz_030.png)  
...
![Separate entities on the left vs continuous change over time on the right](resources/image/dataviz_020.png)  
