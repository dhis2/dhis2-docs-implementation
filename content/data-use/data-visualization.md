...
![Variable categories](resources/image/dataviz_001)  
### Numerical Variables
...
![Chart Chooser by Extreme Presentation Method](resources/image/dataviz_002)
...
![Data visualization styles available in DHIS2](resources/image/dataviz_025)
...
![Scatterplot found in the EPI-Program Performance Dashboard plotting coverage vs dropout rates](resources/image/dataviz_003)
...
![Double axis chart with columns and line showing measles cases and coverage](resources/image/dataviz_004)  
...
![Ordered stacked bar chart of TB cases by reporting district](resources/image/dataviz_005)
...
![Slopes on inpatient malaria incidence across different Districts through time](resources/image/dataviz_006)  
...
![Columns for monthly HIV cases](resources/image/dataviz_007)  
...
![Area chart for the volume of malaria cases in three districts](resources/image/dataviz_008)
Magnitude   
...
![Paired columns of HIV new cases and HIV new cases who started ART across different districts](resources/image/dataviz_009) 
...
![Radar chart on Rehab condition groups and their use across two districts](resources/image/dataviz_010)  
...
![Imrpove the visualization choosing the most suitable colour set](resources/image/dataviz_022)  
...
![Stacked columns for TB cases - lab confirmed and clinically confirmed](resources/image/dataviz_011)
...
![Sex for notified TB cases](resources/image/dataviz_012)  
...
![Coverage rate for BCG](resources/image/dataviz_026)  
...
![Coverage rate for BCG with a colour-based legend representative of the EPI coverage threshold](resources/image/dataviz_027)  
...
![Pivot table of the target population for a supplementary immunisation activity by age groups, distance from the PoC, and locations. Note the row and column totals as well as the subtotals by category](resources/image/dataviz_028)  
...
![Scorecard highlighting the MR coverage reported by routine EPI- and SIA-related activities](resources/image/dataviz_031)  
...
![Map showing the percentage of PTB-BC cases in a region](resources/image/dataviz_013)  
...
![Map showing number of notified cases in a region](resources/image/dataviz_014)  

![Map showing the location of the unvaccinated children and the reason for the missed vaccination](resources/image/dataviz_015)  

- **Dot density**: Shows the location of events. Each dot represents a set number of occurrences of a phenomenon.  

![Map showing the population density in the region](resources/image/dataviz_021)  
...
![Map showing the mean temperatures across the country](resources/image/dataviz_016)  
...
![The chart appears cluttered and difficult to interpret](resources/image/dataviz_017)  
...
![Cluttered graph by lower OUs](resources/image/dataviz_032)  
...
![Overloading a map with too many layers and data points](resources/image/dataviz_023)  
...
![The items in the dashboards are too small for what they need to convey, the labels are unreadable, the pivot table does not have space to display the variables](resources/image/dataviz_023)  
...
![Contextualized graph](resources/image/dataviz_024)  
...
![Pie charts with a lare number of categories to be compared](resources/image/dataviz_018)  
...
![Doses given as a total within the country and the doses by district](resources/image/dataviz_019)  
...
![Spider chart used wrongly to display the changes in notified TB cases over time](resources/image/dataviz_029)  
...
![Double axis wrongly unifying stand alone entities](resources/image/dataviz_030)  
...
![Separate entities on the left vs continuous change over time on the right](resources/image/dataviz_020)  
