...
> **Note**
>
> An integration reference implementation is not ready-to-use software. It needs to be reviewed and adjusted to fit your own systems, data, and security requirements before it can be relied upon.
