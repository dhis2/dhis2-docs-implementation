...
The University of Oslo (UiO) was commissioned by the Global Fund, as part of the action plan of the Community Data Working Group of the [Health Data Collaborative](http://healthdatacollaborative.org/) to develop a "guidance document" on community health information systems (CHIS), training curriculum, and modular toolkit for routine CHIS as an integrated component of routine health information systems (RHIS).
